    ...
    def _parse_simple_expression(self, xml):
        ...
        for element in xml:
            if element.tag == "ValueExpression":
                ...
                print("Value before push:", expression_stack)
                self._push(expression_stack, value)
                print("Value after push:", expression_stack)
        ...
        print("Expression before push:", self.stack)
        self._push(self.stack, expression)
        print("Expression after push:", self.stack)
